...
goog.exportSymbol('proto.proto.CallWebRTCRequest', null, global);
goog.exportSymbol('proto.proto.CallWebRTCResponse', null, global);
...
goog.exportSymbol('proto.proto.HangUpWebRTCRequest', null, global);
goog.exportSymbol('proto.proto.HangUpWebRTCResponse', null, global);
 ...
 * @constructor
 */
proto.proto.CallWebRTCRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.CallWebRTCRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.CallWebRTCRequest.displayName = 'proto.proto.CallWebRTCRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.proto.CallWebRTCResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.CallWebRTCResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.CallWebRTCResponse.displayName = 'proto.proto.CallWebRTCResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.proto.HangUpWebRTCRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.HangUpWebRTCRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.HangUpWebRTCRequest.displayName = 'proto.proto.HangUpWebRTCRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.proto.HangUpWebRTCResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.HangUpWebRTCResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.HangUpWebRTCResponse.displayName = 'proto.proto.HangUpWebRTCResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.proto.RecordingTrack.repeatedFields_ = [10,11,12];
 ...
 */
proto.proto.RecordingTrack.prototype.getIndicesList = function() {
  return /** @type{!Array<!proto.proto.Index>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.Index, 11));
};
 ...
 * @return {!proto.proto.RecordingTrack} returns this
*/
proto.proto.RecordingTrack.prototype.setIndicesList = function(value) {
 ...
 * @return {!proto.proto.Index}
 */
proto.proto.RecordingTrack.prototype.addIndices = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 11, opt_value, proto.proto.Index, opt_index);
};
 ...
 * @return {!proto.proto.RecordingTrack} returns this
 */
proto.proto.RecordingTrack.prototype.clearIndicesList = function() {
...
proto.proto.RecordingTrack.prototype.getTotaltrackdataList = function() {
  return /** @type{!Array<!proto.proto.TrackData>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.TrackData, 12));
};
...
proto.proto.RecordingTrack.prototype.addTotaltrackdata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 12, opt_value, proto.proto.TrackData, opt_index);
};
 ...
 * @return {!Object}
 */
proto.proto.CallWebRTCRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.CallWebRTCRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.CallWebRTCRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.CallWebRTCRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    recording: jspb.Message.getFieldWithDefault(msg, 1, 0),
    videotrackid: jspb.Message.getFieldWithDefault(msg, 2, 0),
    audiotrackid: jspb.Message.getFieldWithDefault(msg, 3, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.CallWebRTCRequest}
 */
proto.proto.CallWebRTCRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.CallWebRTCRequest;
  return proto.proto.CallWebRTCRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.CallWebRTCRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.CallWebRTCRequest}
 */
proto.proto.CallWebRTCRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {number} */ (reader.readFixed32());
      msg.setVideotrackid(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readFixed32());
      msg.setAudiotrackid(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
      msg.setSdp(value);
 ...
 * @return {!Uint8Array}
 */
proto.proto.CallWebRTCRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.CallWebRTCRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.CallWebRTCRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.CallWebRTCRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRecording();
  if (f !== 0) {
    writer.writeFixed64(
...
/**
 * optional fixed64 recording = 1;
 * @return {number}
 */
proto.proto.CallWebRTCRequest.prototype.getRecording = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.proto.CallWebRTCRequest} returns this
 */
proto.proto.CallWebRTCRequest.prototype.setRecording = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional fixed32 videotrackid = 2;
 * @return {number}
 */
proto.proto.CallWebRTCRequest.prototype.getVideotrackid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.proto.CallWebRTCRequest} returns this
 */
proto.proto.CallWebRTCRequest.prototype.setVideotrackid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional fixed32 audiotrackid = 3;
 * @return {number}
 */
proto.proto.CallWebRTCRequest.prototype.getAudiotrackid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.proto.CallWebRTCRequest} returns this
 */
proto.proto.CallWebRTCRequest.prototype.setAudiotrackid = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.proto.CallWebRTCRequest.prototype.getSdp = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.proto.CallWebRTCRequest} returns this
 */
proto.proto.CallWebRTCRequest.prototype.setSdp = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!Object}
 */
proto.proto.CallWebRTCResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.CallWebRTCResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.CallWebRTCResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.CallWebRTCResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.CallWebRTCResponse}
 */
proto.proto.CallWebRTCResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.CallWebRTCResponse;
  return proto.proto.CallWebRTCResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.CallWebRTCResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.CallWebRTCResponse}
 */
proto.proto.CallWebRTCResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.CallWebRTCResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.CallWebRTCResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.CallWebRTCResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.CallWebRTCResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPeerid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.proto.CallWebRTCResponse.prototype.getPeerid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.proto.CallWebRTCResponse} returns this
 */
proto.proto.CallWebRTCResponse.prototype.setPeerid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.proto.CallWebRTCResponse.prototype.getSdp = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.proto.CallWebRTCResponse} returns this
 */
proto.proto.CallWebRTCResponse.prototype.setSdp = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.proto.HangUpWebRTCRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.HangUpWebRTCRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.HangUpWebRTCRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.HangUpWebRTCRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    peerid: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.HangUpWebRTCRequest}
 */
proto.proto.HangUpWebRTCRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.HangUpWebRTCRequest;
  return proto.proto.HangUpWebRTCRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.HangUpWebRTCRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.HangUpWebRTCRequest}
 */
proto.proto.HangUpWebRTCRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.HangUpWebRTCRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.HangUpWebRTCRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.HangUpWebRTCRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.HangUpWebRTCRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPeerid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.proto.HangUpWebRTCRequest.prototype.getPeerid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.proto.HangUpWebRTCRequest} returns this
 */
proto.proto.HangUpWebRTCRequest.prototype.setPeerid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.proto.HangUpWebRTCResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.HangUpWebRTCResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.HangUpWebRTCResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.HangUpWebRTCResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.HangUpWebRTCResponse}
 */
proto.proto.HangUpWebRTCResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.HangUpWebRTCResponse;
  return proto.proto.HangUpWebRTCResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.HangUpWebRTCResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.HangUpWebRTCResponse}
 */
proto.proto.HangUpWebRTCResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.HangUpWebRTCResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.HangUpWebRTCResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.HangUpWebRTCResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.HangUpWebRTCResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
